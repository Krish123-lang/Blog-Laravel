            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="{{ route('backend.pages.update', $getRecord->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="col-md-12">
                                <label for="inputName5" class="form-label">Slug</label>
                                <input type="text" class="form-control" id="inputName5" value="{{$getRecord->slug}}" name="slug" required>
                            </div>

                            <div class="col-md-12">
                                <label for="inputName5" class="form-label">Title</label>
                                <input type="text" class="form-control" id="inputName5" value="{{$getRecord->title}}" name="title" required>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="inputName5" name="meta_title" required value="{{$getRecord->meta_title}}">
                            </div>

                            <div class="col-md-12">
                                <label for="inputName5" class="form-label">Meta Description</label>
                                <textarea name="meta_description" id="meta_description" cols="30" rows="10" class="form-control tinymce-editor">{{$getRecord->meta_description}}</textarea>
                            </div>
